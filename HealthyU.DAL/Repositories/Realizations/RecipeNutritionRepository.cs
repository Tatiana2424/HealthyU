...
public class RecipeNutritionRepository : RepositoryBase<RecipeNutrition>, IRecipeNutritionRepository
{
    public RecipeNutritionRepository(HealthyUDbContext dbContext)
        : base(dbContext)
    {
    }
}
